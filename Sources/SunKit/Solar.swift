...
//    internal static func makeRange(interval: DateInterval, at: GeographicCoordinates, events: [SolunarEventKind], results: inout [SolunarEvent]) {
//        for event in events {
...
//    }
//
//    internal static func getEvent(_ event: SolarEvent, interval: DateInterval, coordinates: GeographicCoordinates) -> Date? {
